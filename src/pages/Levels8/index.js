...
import {Button, Form, message, Skeleton, Space, Steps, Tabs} from "antd";
    ...
    const tabs = [
        {
            key: 1,
            label: '主世界',
            children: <Master levelForm={master} dstWorldSetting={dstWorldSetting}/>
        },
        {
            key:2,
            label: '从世界1',
            children: <Slave1 levelForm={slave1} dstWorldSetting={dstWorldSetting}/>
        },
        {
            key:3,
            label: '从世界2',
            children: <Slave2 levelForm={slave2} dstWorldSetting={dstWorldSetting}/>
        },
        {
            key:4,
            label: '从世界3',
            children: <Slave3 levelForm={slave3} dstWorldSetting={dstWorldSetting}/>
        },
        {
            key: 5,
            label: '从世界4',
            children: <Slave4 levelForm={slave4} dstWorldSetting={dstWorldSetting}/>
        },
        {
            key: 6,
            label: '从世界5',
            children: <Slave5 levelForm={slave5} dstWorldSetting={dstWorldSetting}/>
        },
        {
            key: 7,
            label: '从世界6',
            children: <Slave6 levelForm={slave6} dstWorldSetting={dstWorldSetting}/>
        },
        {
            key: 8,
            label: '从世界7',
            children: <Slave7 levelForm={slave7} dstWorldSetting={dstWorldSetting}/>
        },
    ]
            ...
            <Card>
                <Box sx={{p: 3}} dir="ltr">
                    <Skeleton loading={loading} active avatar>
                        <Tabs tabPosition={'left'}  defaultActiveKey="1" items={tabs}/>
