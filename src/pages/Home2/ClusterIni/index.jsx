...
export default () => {
    ...
    const [activeTab, setActiveTab] = useState(lang === 'en' ? '全部' : '默认')
        ...
        <>
            ...
            >
                ...
                <Skeleton loading={loading} active>
                    ...
                    >
                        <Divider><span className={style.icon}
                                       style={{fontSize: "14px", fontWeight: "600"}}>{t('cluster.BaseSetting')}󰀃</span></Divider>
                        ...
                        <Form.Item label={t('cluster.pvp')} valuePropName="checked" tooltip="是否开启玩家对战" name='pvp'>
                        ...
                        {activeTab === '全部' && <div>
                            ...
                            <Divider><span style={{
                                fontSize: "14px",
                                fontWeight: "600"
                            }}>{t('cluster.ShardSetting')}</span></Divider>
...
主从服务器都在同一计算机上时，填127.0.0.1 ;否则填主服务器IP只需要为从服务器设置此项"
                            ...
                            <Divider><span style={{
                                fontSize: "14px",
                                fontWeight: "600"
                            }}>{t('cluster.SteamSetting')}</span></Divider>
