...
export default () => {
    ...
    const AddCluster = ({isModalOpen, setIsModalOpen, isUpdate, cluster, setLoading}) => {
        ...
        const handleOk = () => {
            ...
            data.steamcmd = systemSetting.steamcmd
        ...
        <>
            <Card>
                <Spin spinning={spinLoading} tip="正在下载饥荒...请稍等，预计5~20分钟，请提前下载好steamcmd">
                    <AddCluster isModalOpen={isOpenAddCluster} setIsModalOpen={setIsOpenAddCluster} isUpdate
                                setLoading={setSpinLoading}/>
                    <UpdateCluster isModalOpen3={isOpenUpdateCluster} setIsModalOpen3={setIsOpenUpdateCluster}
                                   cluster={cluster}/>
